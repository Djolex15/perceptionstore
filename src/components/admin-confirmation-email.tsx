...
export default function AdminNotificationEmail({ formData }: AdminNotificationEmailProps) {
  ...
  return (
    <Html>
      <Head />
      <Preview>
        New Call Booking: {formData.firstName} {formData.lastName} -{" "}
        {formData.serviceType === "startup-growth" ? "Startup Growth" : "A La Carte"}
      </Preview>
      <Body style={main}>
        <Container style={container}>
          <Heading style={heading}>
            New Call Booking from {formData.firstName} {formData.lastName}
          </Heading>

          <Text style={paragraph}>You have received a new call booking request. Here are the details:</Text>
